...
curl -v -sS "http://localhost:4777/max-age/includes-35-max-age-30-age-40-swr-expires-in-120.json" 
curl -v -sS "http://localhost:4778/max-age/includes-35-max-age-30-age-40-swr-expires-in-120.json" 
curl -v -sS "http://localhost:4778/max-age/includes-35-max-age-30-age-40-swr-expires-in-120.json" 2>&1 | grep "Cache-Control" | tr -d "\n"
exit $?
